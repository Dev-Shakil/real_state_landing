    ...
    <div className="bg-white overflow-hidden group rounded-lg cursor-pointer shadow-lg">
        <div className="relative">
            <Image
             ...
             <div className="flex items-center space-x-1 px-6 absolute top-4 py-2 left-4 py2 text-m bg-rose-600 w-fit text-white rounded-md font-bold">
                <MdElectricBolt />
                <span>Featured</span>
             </div>
        </div>
        <div className="p-5">
            ...
            <p className="text-sm text-gray-500 mt-6">{property.location}</p>
